...
2. clearDB add-on의 ignite를 설치한다 (ignite가 무료로 사용할 수 있는 커뮤니티 버전이다)
...
3. heroku는 똑똑하게 이미 환경변수로 db remote 주소를 받아놨다. grep으로 주소를 확보해주자.
...
4. 3의 과정을 거쳐 이렇게 DB 서버의 주소가 확보되었다. 끝!
